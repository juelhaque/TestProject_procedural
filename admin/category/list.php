...
<body id="body-pd">
    ...
    <main>
        <div class="height-100 bg-light">
            ...
            <hr>
            <div>
                <a class="btn btn-primary" href="../category/creat.php">Creat</a>
            </div>
            <br>
            <div>
                    ...
                    foreach ($categores as $category) {  ?> <!--যতগুলি ডাটা ইনসার্ট করা আছে লুপ ততবার ঘুরবে। category এর পরিবর্তে যে কোনো ওয়ার্ড লেখা যাবে, $categories এর ডাটা গুলো $category তে অ্যারে হিসাবে স্টোর হবে।------->
                        <tr class="">
                            ...
                            <td scope="row" class="d-flex">
                                <a class="btn btn-success me-1" href="show.php?id=<?= $category['id']; ?>">Show</a> <!-- ?id= আইডি প্যারাম বলা হয়, প্রত্তেকটি ইনসার্টেড ডাটার আইডি সেই ডাটার জন্য ক্যাস করবে, এখন যদি show button এ মাউস রাখি তাহলে ঐলাইনের ডাটার আইডি দেখাবে, এই স্পেসিফিক আইডি ধরে showInsertedData.php পেজ এ স্পেসিফিক ডাটা দেখাবো, show button এ ক্লিক করলে দেখতে পাবো সার্স বার দিয়ে ডাটা পাস হচ্ছে -->
                                <a class="btn btn-info me-1" href="edit.php?id=<?= $category['id']; ?>">Edit</a>
                                <form action="./delete.php" method="post"> <!--এখান থেকে ইনপুট ডাটার আইডি delete.php পেজ এ পাঠাবো। আমরা যদি GET দিয়ে ডাটা এখান থেকে delete.php পেজ এ ডাটা পাঠাইতাম, তাহলে url এ ইনসার্টেড ডাটার আইডি পরিবর্তন করে ইন্টার করলে ডাটাটি ডিলিট হয়ে যাইতো, তাই form দিয়ে ডাটা পাঠানো হয়েছে। -------------------->
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary" onclick="confirm ('Are You Sure?')">Delete</button>
                                </form>
                            </td>
                        </tr>
                    <?php }  ?>
